...
input_features = rice_dataset_raw[[
    'Area',
    'Major_Axis_Length',
    'Eccentricity',
...
number_samples = len(input_features)
index_80th = round(number_samples * 0.8)
index_90th = index_80th + round(number_samples * 0.1)

# Randomize order and split into train, validation, and test with a .8, .1, .1 split
shuffled_dataset = input_features.sample(frac=1, random_state=100)
...
validation_labels = validation_data['Area'].to_numpy()
...
def train_model(
  ...
  features = {
      feature_name: np.array(dataset['Area'])
