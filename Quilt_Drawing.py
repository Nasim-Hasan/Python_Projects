...
def main():
    ...
    draw_circle_patch_2(canvas,0,PATCH_SIZE)
    draw_square_patch(canvas,PATCH_SIZE,PATCH_SIZE)
    draw_circle_patch_2(canvas,PATCH_SIZE*2,PATCH_SIZE)
...
def draw_circle_patch(canvas, start_x, start_y):
    ...
    if end_x>CANVAS_WIDTH:
        end_x=CANVAS_WIDTH
    canvas.create_oval(start_x,0,end_x,end_y,'salmon')

def draw_circle_patch_2(canvas, start_x, start_y):
